...
/** Contact page: dark hero + light body with audit hook, details and a form. */
  ...
  return (
    <>
      <PageHero
        ...
        tagline="Vertel ons over je project. Je krijgt een gratis website-audit met concrete groeikansen, binnen twee werkdagen."
          ...
          <div>
            ...
            <Reveal delay={0.05}>
              <p className="mt-6 max-w-md font-sans text-lg leading-relaxed text-near-black/65">
                Een kort gesprek is vaak genoeg om te zien waar de groei zit. Bel,
                app of mail, we reageren snel.
              </p>
            </Reveal>
